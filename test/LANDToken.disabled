...
contract('LANDToken', function ([owner, user1, user2]) {
  ...
  it('should allow updating multiple LAND updates', async function () {
    ...
    const resultLand3 = await world.landMetadata(5, 4)
    resultLand3.should.equal('Changed')
  })
})
